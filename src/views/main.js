          ...
          <div className="flex flex-wrap items-center pt-32">
                ...
                <div className="my-4 w-full lg:w-6/12 px-4">
                  ...
                  >
                    <div className="bg-red-600 shadow-lg rounded-lg text-center p-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">E</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="bg-lightBlue-500 shadow-lg rounded-lg text-center p-8 mt-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">S</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="bg-blueGray-700 shadow-lg rounded-lg text-center p-8 mt-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">T</p>
                    </div>
                  </a>
                  <a
                    href="https://www.creative-tim.com/learning-lab/tailwind/nextjs/alerts/notus?ref=vtw-index"
                    target="_blank"
                  >
                    <div className="bg-indigo-400 shadow-lg rounded-lg text-center p-8 mt-8">
                      <img
                        alt="..."
                        className="shadow-md rounded-full max-w-full w-16 mx-auto p-2 bg-white"
                        src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/logos/nextjs.jpg"
                      />
                      <p className="text-lg text-white mt-4 font-semibold">J</p>
                    </div>
                  </a>
                </div>
                <div className="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
                  ...
                  >
                    <div className="bg-yellow-500 shadow-lg rounded-lg text-center p-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">I</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="bg-red-700 shadow-lg rounded-lg text-center p-8 mt-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">N</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div className="bg-emerald-500 shadow-lg rounded-lg text-center p-8 mt-8">
                      ...
                      />
                      <p className="text-lg text-white mt-4 font-semibold">F</p>
                    </div>
                  </a>
                  <a
                    href="https://www.creative-tim.com/learning-lab/tailwind/vue/alerts/notus?ref=vtw-index"
                    target="_blank"
                  >
                    <div className="bg-pink-400 shadow-lg rounded-lg text-center p-8 mt-8">
                      <img
                        alt="..."
                        className="shadow-md rounded-full max-w-full w-16 mx-auto p-2 bg-white"
                        src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/logos/vue.jpg"
                      />
                      <p className="text-lg text-white mt-4 font-semibold">P</p>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                MBTI 관련된 여러분의 이야기를 나눠보세요!
              </p>
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                We created a set of Pages that are dynamic community.
              </p>
          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                ...
                <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                  친구들과 서로의 MBTI를 검사하고 타인이 보는 나의 모습은
                  무엇인지 알아가보세요.
                </p>
